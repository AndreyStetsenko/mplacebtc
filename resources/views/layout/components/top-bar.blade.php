    ...
    <div class="intro-x dropdown w-8 h-8">
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="{{ route('user.view', Auth::user()->id) }}" class="dropdown-item hover:bg-white/5">
                        <i data-feather="user" class="w-4 h-4 mr-2"></i> Профиль
                    </a>
                </li>
                <li>
                    <a href="{{ route('user.create') }}" class="dropdown-item hover:bg-white/5">
                ...
                <li>
                    <a href="{{ route('home') }}" class="dropdown-item hover:bg-white/5">
